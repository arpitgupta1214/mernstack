...
console.log(keyword)
   ...
   useEffect(()=>{
    ...
    const res = await axios.get(`http://localhost:5000/api/domain?keyword=${keyword}`)
  ...
  return (
    ...
    <div class="table_elements">
      <div className="show_entries">
        ...
        <span>
          <select class="en_selectbox" name="" id="">
            <option>10</option>
      ...
      <div className="search_div">
       <form>
       <input className="search" placeholder="Search" name='q' 
